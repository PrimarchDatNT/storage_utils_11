...
public abstract class CubicCurve2D implements Shape, Cloneable
{
     ...
     * methods below.
     *
     * @see com.wxiwei.java.awt.geom.geom.CubicCurve2D.Float
     * @see com.wxiwei.java.awt.geom.geom.CubicCurve2D.Double
     * @since 1.2
     */
    ...
    public boolean contains(double x, double y)
    {
        ...
        double x2 = getX2();
        double y2 = getY2();*/
        int crossings = 0;/*(Curve.pointCrossingsForLine(x, y, x1, y1, x2, y2) + Curve
            .pointCrossingsForCubic(x, y, x1, y1, getCtrlX1(), getCtrlY1(), getCtrlX2(),
                getCtrlY2(), x2, y2, 0));*/
