    ...
    implements Shape, java.io.Serializable
{
     ...
     * @see       #getBounds
     * @see	  java.awt.Component#setBounds(office.java.awt.Rectangle)
     * @since     1.1
     */
     ...
     *                 along the Y axis
     * @see       office.java.awt.Rectangle#setLocation(int, int)
     * @see       office.java.awt.Rectangle#setLocation(java.awt.Point)
     */
     ...
     * @see       java.awt.Component#setSize(office.java.awt.Dimension)
     * @see       #getSize
     * @since     1.1
     */
