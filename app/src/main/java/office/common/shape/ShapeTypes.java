...
public interface ShapeTypes {
    ...
    public static final int HomePlate = 15;                                 // 五边形
    ...
    public static final int Callout2 = 41;
    public static final int Callout3 = 42;
    public static final int Callout4 = 43;
    public static final int AccentCallout2 = 44;
    public static final int AccentCallout3 = 45;
    public static final int AccentCallout4 = 46;
    public static final int BorderCallout2 = 47;
    public static final int BorderCallout3 = 48;
    public static final int BorderCallout4 = 49;
    public static final int AccentBorderCallout2 = 50;
    public static final int AccentBorderCallout3 = 51;
    public static final int AccentBorderCallout4 = 52;
    public static final int Ribbon = 53;                                    // 前凸带形
    public static final int Ribbon2 = 54;                                   // 上凸带形
    public static final int Chevron = 55;                                   // 燕尾形
    ...
    public static final int IrregularSeal1 = 71;                            // 爆炸形1
    public static final int IrregularSeal2 = 72;                            // 爆炸形2
    ...
    public static final int LeftUpArrow = 89;                               // 直角双向箭头
    public static final int BentUpArrow = 90;                               // 直角上箭头
    public static final int BentArrow = 91;                                 // 圆角右箭头
    public static final int Star24 = 92;
    public static final int StripedRightArrow = 93;                         // 虚尾箭头
    public static final int NotchedRightArrow = 94;                         // 燕尾形箭头
    ...
    public static final int CircularArrow = 99;                             // 环形箭头
    public static final int NotchedCircularArrow = 100;
    public static final int UturnArrow = 101;                               // 手杖形箭头
    public static final int CurvedRightArrow = 102;                         // 左弧形箭头
    public static final int CurvedLeftArrow = 103;                          // 右弧形箭头
    public static final int CurvedUpArrow = 104;                            // 下弧形箭头
    public static final int CurvedDownArrow = 105;                          // 上弧形箭头
    public static final int CloudCallout = 106;
    public static final int EllipseRibbon = 107;                            // 前凸弯带形
    public static final int EllipseRibbon2 = 108;                           // 上凸弯带形
    ...
    public static final int Callout1 = 178;
    public static final int AccentCallout1 = 179;
    public static final int BorderCallout1 = 180;
    public static final int AccentBorderCallout1 = 181;
    public static final int LeftRightUpArrow = 182;                         // 丁字箭头
    ...
    public static final int Star4 = 187;                                    // 十字星
    public static final int DoubleWave = 188;                               // 双波形
    ...
    public static final int IsocelesTriangle = 203;
    public static final int RightTriangle = 204;
    public static final int Arrow = 205;
    public static final int Callout90 = 206;
    public static final int AccentCallout90 = 207;
    public static final int BorderCallout90 = 208;
    public static final int AccentBorderCallout90 = 209;

    // add new
    public static final int Round1Rect = 210;
    public static final int Round2SameRect = 211;
    public static final int Round2DiagRect = 212;
    public static final int Snip1Rect = 213;
    public static final int Snip2SameRect = 214;
    public static final int Snip2DiagRect = 215;
    public static final int SnipRoundRect = 216;
    public static final int Heptagon = 217;
    public static final int Decagon = 218;
    public static final int Dodecagon = 219;
    public static final int Pie = 220;
    public static final int Chord = 221;
    public static final int Teardrop = 222;
    public static final int Frame = 223;
    public static final int HalfFrame = 224;
    public static final int Corner = 225;
    public static final int DiagStripe = 226;
    public static final int MathPlus = 227;
    public static final int MathMinus = 228;
    public static final int MathMultiply = 229;
    public static final int MathDivide = 230;
    public static final int MathEqual = 231;
    public static final int MathNotEqual = 232;
    //Arbitrary polygon
    public static final int ArbitraryPolygon = 233;
    public static final int Cloud = 234;
    public static final int Star5 = 235;
    public static final int Star6 = 236;
    public static final int Star7 = 237;
    public static final int Star10 = 238;
    public static final int Star12 = 239;

    /**
     * for smart art shape
     */
    public static final int Funnel = 240;
    public static final int Gear6 = 241;
    public static final int Gear9 = 242;
    public static final int LeftCircularArrow = 243;
    public static final int LeftRightRibbon = 244;
    public static final int PieWedge = 245;
    public static final int SwooshArrow = 246;

    public static final int WP_Line = 247;
    public static final int Curve = 248;
    //direct line polygon
    public static final int DirectPolygon = 249;
}
