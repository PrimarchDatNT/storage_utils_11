...
{/*
    ...
    *//**
    ...
    private void setupContent(LinearLayout contentPanel)
    {
        ...
        else
        {
            ...
            if (mListView != null)
            {
                ...
                contentPanel.addView(mListView, new LinearLayout.LayoutParams(FILL_PARENT,
                    FILL_PARENT));
        ...
        boolean hasButtons, TypedArray a, boolean hasTitle, View buttonPanel)
    {
        ...
        int fullDark = a
            .getResourceId(R.styleable.AlertDialog_fullDark, R.drawable.popup_full_dark);
        ...
        int topBright = a.getResourceId(R.styleable.AlertDialog_topBright,
            R.drawable.popup_top_bright);
        int centerBright = a.getResourceId(R.styleable.AlertDialog_centerBright,
            R.drawable.popup_center_bright);
        int bottomBright = a.getResourceId(R.styleable.AlertDialog_bottomBright,
            R.drawable.popup_bottom_bright);
        int bottomMedium = a.getResourceId(R.styleable.AlertDialog_bottomMedium,
            R.drawable.popup_bottom_medium);
        int centerMedium = a.getResourceId(R.styleable.AlertDialog_centerMedium,
            R.drawable.popup_center_medium);
            ...
            if (mIsMultiChoice)
            {
                if (mCursor == null)
                {
                    adapter = new ArrayAdapter<CharSequence>(mContext,
                        R.layout.select_dialog_multichoice, R.id.text1, mItems)
                    {
                        @ Override
                ...
                else
                {
                    adapter = new CursorAdapter(mContext, mCursor, false)
                    {
                        ...
                        {
                            return mInflater.inflate(R.layout.select_dialog_multichoice, parent,
                                false);
                        }
