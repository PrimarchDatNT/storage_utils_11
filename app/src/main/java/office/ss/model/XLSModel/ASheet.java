 ...
 * 时间:              下午1:55:20
 */
package office.ss.model.XLSModel;
...
import office.common.shape.AChart;
...
import office.constant.SSConstant;
import office.fc.hssf.model.InternalSheet;
import office.fc.hssf.model.InternalWorkbook;
import office.fc.hssf.record.BlankRecord;
...
import office.fc.hssf.usermodel.HSSFAutoShape;
import office.fc.hssf.usermodel.HSSFChart;
import office.fc.hssf.usermodel.HSSFChildAnchor;
import office.fc.hssf.usermodel.HSSFClientAnchor;
import office.fc.hssf.usermodel.HSSFFreeform;
import office.fc.hssf.usermodel.HSSFLine;
import office.fc.hssf.usermodel.HSSFPatriarch;
import office.fc.hssf.usermodel.HSSFPicture;
import office.fc.hssf.usermodel.HSSFPictureData;
import office.fc.hssf.usermodel.HSSFRichTextString;
import office.fc.hssf.usermodel.HSSFShape;
import office.fc.hssf.usermodel.HSSFShapeGroup;
import office.fc.hssf.usermodel.HSSFSheet;
import office.fc.hssf.usermodel.HSSFTextbox;
import office.fc.hssf.usermodel.HSSFWorkbook;
import office.fc.hssf.util.HSSFPaneInformation;
import office.fc.ss.util.HSSFCellRangeAddress;
import office.fc.xls.ChartConverter;
...
import office.ss.model.drawing.AnchorPoint;
import office.ss.model.drawing.CellAnchor;
import office.ss.model.sheetProperty.PaneInformation;
import office.ss.util.ModelUtil;
import office.ss.util.SectionElementFactory;
import office.system.AbortReaderError;
import office.system.AbstractReader;
import office.system.IControl;
import office.thirdpart.achartengine.chart.AbstractChart;
import office.thirdpart.achartengine.chart.RoundChart;
import office.thirdpart.achartengine.chart.XYChart;
import office.thirdpart.achartengine.renderers.DefaultRenderer;
 ...
 * <p>
 */
public class ASheet extends Sheet implements office.fc.ss.usermodel.Sheet
{
     ...
     * @see office.fc.hssf.usermodel.HSSFWorkbook#createSheet()
     */
    protected ASheet(AWorkbook workbook, InternalSheet sheet)
    {
        ...
        List<office.fc.hssf.util.ColumnInfo> hssfColumnInfoList = sheet.getColumnInfo();
        if(hssfColumnInfoList != null)
        {
            Iterator<office.fc.hssf.util.ColumnInfo> iter = hssfColumnInfoList.iterator();
            while(iter.hasNext())
            {
                office.fc.hssf.util.ColumnInfo hssfColumnInfo = iter.next();
                office.ss.model.sheetProperty.ColumnInfo columnInfo = new office.ss.model.sheetProperty.ColumnInfo(
