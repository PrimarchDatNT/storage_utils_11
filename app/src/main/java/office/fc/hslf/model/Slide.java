...
import office.fc.hslf.record.Comment2000;
...
public final class Slide extends Sheet
{
     ...
     */
    public Slide(office.fc.hslf.record.Slide slide, Notes notes, SlideAtomsSet atomSet,
    ...
    */
    ...
    {
        super(new office.fc.hslf.record.Slide(), sheetNumber);
        _slideNo = slideNumber;
    ...
    * @see office.fc.hslf.usermodel.SlideShow#reorderSlide(int, int)
    */
     ...
     */
    public office.fc.hslf.record.Slide getSlideRecord()
    {
        return (office.fc.hslf.record.Slide)getSheetContainer();
    }
