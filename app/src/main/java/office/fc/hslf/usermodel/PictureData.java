...
import office.fc.hslf.blip.DIB;
import office.fc.hslf.blip.EMF;
import office.fc.hslf.blip.ImagePainter;
import office.fc.hslf.blip.JPEG;
import office.fc.hslf.blip.PICT;
import office.fc.hslf.blip.PNG;
import office.fc.hslf.blip.WMF;
    ...
    */
    ...
    /*public void draw(Graphics2D graphics, Picture parent)
    {
        ...
        if (painter != null)
            ...
            logger.log(POILogger.WARN, "Rendering is not supported: " + getClass().getName());
    }*/
