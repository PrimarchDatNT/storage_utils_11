...
import office.fc.hssf.record.AutoFilterInfoRecord;
import office.fc.hssf.record.CellValueRecordInterface;
import office.fc.hssf.record.DVRecord;
...
import office.fc.hssf.record.aggregates.FormulaRecordAggregate;
...
import office.fc.hssf.util.Region;
import office.fc.ss.SpreadsheetVersion;
import office.fc.ss.usermodel.CellRange;
import office.fc.ss.usermodel.DataValidation;
import office.fc.ss.usermodel.DataValidationHelper;
import office.fc.ss.usermodel.ICell;
import office.fc.ss.usermodel.ICellStyle;
import office.fc.ss.usermodel.IRow;
import office.fc.ss.util.CellReference;
import office.fc.ss.util.HSSFCellRangeAddress;
import office.fc.ss.util.SSCellRange;
import office.fc.ss.util.SheetUtil;
 ...
 */
public final class HSSFSheet implements office.fc.ss.usermodel.Sheet
{
     ...
     * @see office.fc.hssf.usermodel.HSSFRow
     * @see #removeRow(com.office.fc.ss.usermodel.IRow)
     */
   ...
   public void setColumnPixelWidth(int columnIndex, int width)
   {
     ...
     */
    public int addMergedRegion(office.fc.ss.util.Region region)
    {
     ...
     *
     *  <p>
     *  Calculating the formula values with {@link office.fc.ss.usermodel.office.fc.ss.usermodel.FormulaEvaluator} is the
     ...
     *  {@link office.ss.model.baseModel.office.fc.ss.usermodel.Workbook#setForceFormulaRecalculation(boolean)}
     ...
     *
     * @see office.ss.model.baseModel.office.fc.ss.usermodel.Workbook#setForceFormulaRecalculation(boolean)
     */
