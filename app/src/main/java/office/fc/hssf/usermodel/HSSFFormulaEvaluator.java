...
import office.fc.hssf.formula.CollaboratingWorkbooksEnvironment;
import office.fc.hssf.formula.IStabilityClassifier;
import office.fc.hssf.formula.WorkbookEvaluator;
...
import office.fc.ss.usermodel.CellValue;
import office.fc.ss.usermodel.FormulaEvaluator;
import office.fc.ss.usermodel.ICell;
import office.fc.ss.usermodel.Workbook;
...
public class HSSFFormulaEvaluator implements FormulaEvaluator
{
     ...
     * replaced with the result of the formula, use {@link #evaluateInCell(com.office.fc.ss.usermodel.ICell)}
