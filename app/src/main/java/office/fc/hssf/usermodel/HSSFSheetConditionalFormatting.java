...
import office.fc.hssf.record.aggregates.CFRecordsAggregate;
import office.fc.hssf.record.aggregates.ConditionalFormattingTable;
import office.fc.ss.SpreadsheetVersion;
import office.fc.ss.usermodel.ConditionalFormatting;
import office.fc.ss.usermodel.ConditionalFormattingRule;
import office.fc.ss.usermodel.SheetConditionalFormatting;
import office.fc.ss.util.HSSFCellRangeAddress;
import office.fc.ss.util.Region;
...
public final class HSSFSheetConditionalFormatting implements SheetConditionalFormatting {
	 ...
	 *		 <tt>{@link office.fc.hssf.record.CFRuleRecord.ComparisonOperator}</tt>: <p>
	 * <ul>
	 *		 <li>BETWEEN</li>
	 *		 <li>NOT_BETWEEN</li>
	 *		 <li>EQUAL</li>
	 ...
	 * {@link office.fc.hssf.record.CFRuleRecord.ComparisonOperator#BETWEEN}) and
	 * {@link office.fc.hssf.record.CFRuleRecord.ComparisonOperator#NOT_BETWEEN} operations)
	 */
