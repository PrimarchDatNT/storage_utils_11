...
import office.fc.hssf.record.CommonObjectDataSubRecord;
...
import office.fc.ss.usermodel.Comment;
import office.fc.ss.usermodel.FormulaError;
import office.fc.ss.usermodel.ICell;
import office.fc.ss.usermodel.ICellStyle;
import office.fc.ss.usermodel.IHyperlink;
import office.fc.ss.usermodel.RichTextString;
import office.fc.ss.util.CellReference;
import office.fc.ss.util.HSSFCellRangeAddress;
import office.fc.ss.util.NumberToTextConverter;
...
public class HSSFCell implements ICell {
     ...
     *
     * @see office.fc.hssf.usermodel.HSSFRow#createCell(short)
     */
     ...
     *                Type of cell
     * @see office.fc.hssf.usermodel.HSSFRow#createCell(short,int)
     */
...
//        agg.setParsedExpression(ptgs);
     ...
     * @see office.fc.hssf.usermodel.HSSFWorkbook#createCellStyle()
     * @see office.fc.hssf.usermodel.HSSFWorkbook#getCellStyleAt(short)
     */
     ...
     * @see HSSFRow#removeCell(com.office.fc.ss.usermodel.ICell)
     * @see office.fc.hssf.usermodel.HSSFSheet#removeRow(org.apache.poi.ss.usermodel.Row)
     * @see office.fc.hssf.usermodel.HSSFSheet#shiftRows(int, int, int)
     * @see office.fc.hssf.usermodel.HSSFSheet#addMergedRegion(office.fc.ss.util.HSSFCellRangeAddress)
