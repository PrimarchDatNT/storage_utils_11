...
import office.fc.POIDocument;
import office.fc.codec.DigestUtils;
import office.fc.ddf.EscherBSERecord;
import office.fc.ddf.EscherBitmapBlip;
import office.fc.ddf.EscherBlipRecord;
import office.fc.ddf.EscherRecord;
import office.fc.hssf.OldExcelFormatException;
import office.fc.hssf.formula.FormulaShifter;
import office.fc.hssf.formula.FormulaType;
import office.fc.hssf.formula.SheetNameFormatter;
import office.fc.hssf.formula.ptg.Area3DPtg;
import office.fc.hssf.formula.ptg.MemFuncPtg;
import office.fc.hssf.formula.ptg.Ptg;
import office.fc.hssf.formula.ptg.UnionPtg;
import office.fc.hssf.formula.udf.AggregatingUDFFinder;
import office.fc.hssf.formula.udf.UDFFinder;
import office.fc.hssf.model.DrawingManager2;
import office.fc.hssf.model.HSSFFormulaParser;
import office.fc.hssf.model.InternalSheet;
import office.fc.hssf.model.InternalWorkbook;
import office.fc.hssf.model.RecordStream;
import office.fc.hssf.record.AbstractEscherHolderRecord;
import office.fc.hssf.record.BackupRecord;
import office.fc.hssf.record.DrawingGroupRecord;
import office.fc.hssf.record.EmbeddedObjectRefSubRecord;
import office.fc.hssf.record.ExtendedFormatRecord;
import office.fc.hssf.record.FontRecord;
import office.fc.hssf.record.LabelRecord;
import office.fc.hssf.record.LabelSSTRecord;
...
import office.fc.hssf.record.RecordFactory;
import office.fc.hssf.record.SSTRecord;
import office.fc.hssf.record.SubRecord;
...
import office.fc.hssf.util.CellReference;
import office.fc.poifs.filesystem.DirectoryNode;
import office.fc.poifs.filesystem.POIFSFileSystem;
import office.fc.ss.usermodel.IRow.MissingCellPolicy;
import office.fc.ss.util.WorkbookUtil;
 ...
 */
public final class HSSFWorkbook extends POIDocument implements office.fc.ss.usermodel.Workbook
{
     ...
     *        in memory
     * @see office.fc.poifs.filesystem.POIFSFileSystem
...
//            names.add(name);
    ...
    /**
      ...
      * @see office.fc.hssf.record.LabelRecord
      * @see office.fc.hssf.record.LabelSSTRecord
     ...
     * @see office.fc.hssf.usermodel.HSSFSheet#setSelected(boolean)
     */
     ...
     * @see {@link office.fc.ss.util.WorkbookUtil#createSafeSheetName(String nameProposal)}
     ...
     */
    public int getSheetIndex(office.fc.ss.usermodel.Sheet sheet)
    {
