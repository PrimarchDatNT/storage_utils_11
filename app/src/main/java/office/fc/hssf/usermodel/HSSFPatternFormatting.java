...
import office.fc.hssf.record.cf.PatternFormatting;
 ...
 *
 */
public class HSSFPatternFormatting implements office.fc.ss.usermodel.PatternFormatting
{
	...
	/**
	 * @see office.fc.hssf.record.cf.PatternFormatting#getFillBackgroundColor()
	 */
	...
	/**
	 * @see office.fc.hssf.record.cf.PatternFormatting#getFillForegroundColor()
	 */
	...
	/**
	 * @see office.fc.hssf.record.cf.PatternFormatting#getFillPattern()
	 */
	...
	/**
	 * @param bg
	 * @see office.fc.hssf.record.cf.PatternFormatting#setFillBackgroundColor(int)
	 */
	...
	/**
	 * @param fg
	 * @see office.fc.hssf.record.cf.PatternFormatting#setFillForegroundColor(int)
	 */
	...
	/**
	 * @param fp
	 * @see office.fc.hssf.record.cf.PatternFormatting#setFillPattern(int)
	 */
