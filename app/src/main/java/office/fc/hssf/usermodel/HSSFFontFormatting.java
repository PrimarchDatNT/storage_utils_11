...
import office.fc.hssf.record.CFRuleRecord;
import office.fc.hssf.record.cf.FontFormatting;
 ...
 *
 */
public final class HSSFFontFormatting implements office.fc.ss.usermodel.FontFormatting
{
	...
	/**
	 * @see office.fc.hssf.record.cf.FontFormatting#getRawRecord()
	 */
	...
	/**
	 * @param modified
	 * @see office.fc.hssf.record.cf.FontFormatting#setEscapementTypeModified(boolean)
	 */
	...
	/**
	 * @param modified
	 * @see office.fc.hssf.record.cf.FontFormatting#setFontCancellationModified(boolean)
	 */
	...
	/**
	 * @param fci
	 * @see office.fc.hssf.record.cf.FontFormatting#setFontColorIndex(short)
	 */
	...
	/**
	 * @param height
	 * @see office.fc.hssf.record.cf.FontFormatting#setFontHeight(int)
	 */
	...
	/**
	 * @param modified
	 * @see office.fc.hssf.record.cf.FontFormatting#setFontOutlineModified(boolean)
	 */
	...
	/**
	 * @param modified
	 * @see office.fc.hssf.record.cf.FontFormatting#setFontShadowModified(boolean)
	 */
	...
	/**
	 * @param modified
	 * @see office.fc.hssf.record.cf.FontFormatting#setFontStyleModified(boolean)
	 */
	...
	/**
	 * @param on
	 * @see office.fc.hssf.record.cf.FontFormatting#setOutline(boolean)
	 */
	...
	/**
	 * @param on
	 * @see office.fc.hssf.record.cf.FontFormatting#setShadow(boolean)
	 */
	...
	/**
	 * @param strike
	 * @see office.fc.hssf.record.cf.FontFormatting#setStrikeout(boolean)
	 */
	...
	/**
	 * @param modified
	 * @see office.fc.hssf.record.cf.FontFormatting#setUnderlineTypeModified(boolean)
	 */
