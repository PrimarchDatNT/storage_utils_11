...
import office.fc.ss.usermodel.IFont;
 ...
 * @see office.fc.hssf.usermodel.HSSFCell#setCellStyle(HSSFCellStyle)
 */
public final class HSSFCellStyle implements ICellStyle {
     ...
     * @see office.fc.hssf.usermodel.HSSFDataFormat
     */
     ...
     * @return the format string or "General" if not found
     */
    public String getDataFormatString(office.fc.ss.usermodel.Workbook workbook) {
     ...
     * @see office.fc.hssf.usermodel.HSSFDataFormat
     */
    public String getDataFormatString(office.fc.hssf.model.InternalWorkbook workbook)
    {
...
//        return format.getFormat(getDataFormat());
     ...
     * @see office.fc.hssf.usermodel.HSSFWorkbook#createFont()
     * @see office.fc.hssf.usermodel.HSSFWorkbook#getFontAt(short)
     */
     ...
     * @see office.fc.hssf.usermodel.HSSFCellStyle#getFontIndex()
     * @see office.fc.hssf.usermodel.HSSFWorkbook#getFontAt(short)
     */
    public HSSFFont getFont(office.fc.ss.usermodel.Workbook parentWorkbook) {
     ...
     * @see office.fc.hssf.usermodel.HSSFPalette#getColor(short)
    ...
    private void checkDefaultBackgroundFills() {
      if (_format.getFillForeground() == office.fc.hssf.util.HSSFColor.AUTOMATIC.index) {
    	  ...
    	  if (_format.getFillBackground() != (office.fc.hssf.util.HSSFColor.AUTOMATIC.index+1))
    		  setFillBackgroundColor((short)(office.fc.hssf.util.HSSFColor.AUTOMATIC.index+1));
      } else if (_format.getFillBackground() == office.fc.hssf.util.HSSFColor.AUTOMATIC.index+1)
    	  //Now if the forground changes to a non-AUTOMATIC color the background resets itself!!!
    	  if (_format.getFillForeground() != office.fc.hssf.util.HSSFColor.AUTOMATIC.index)
    		  setFillBackgroundColor(office.fc.hssf.util.HSSFColor.AUTOMATIC.index);
    }
