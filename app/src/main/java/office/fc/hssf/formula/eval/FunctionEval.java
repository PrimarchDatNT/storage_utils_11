...
package office.fc.hssf.formula.eval;

import office.fc.hssf.formula.function.Address;
import office.fc.hssf.formula.function.AggregateFunction;
import office.fc.hssf.formula.function.Averagea;
import office.fc.hssf.formula.function.BooleanFunction;
import office.fc.hssf.formula.function.CalendarFieldFunction;
import office.fc.hssf.formula.function.Choose;
import office.fc.hssf.formula.function.Column;
import office.fc.hssf.formula.function.Columns;
import office.fc.hssf.formula.function.Count;
import office.fc.hssf.formula.function.Counta;
import office.fc.hssf.formula.function.Countblank;
import office.fc.hssf.formula.function.Countif;
import office.fc.hssf.formula.function.DateFunc;
import office.fc.hssf.formula.function.Days360;
import office.fc.hssf.formula.function.Errortype;
import office.fc.hssf.formula.function.Even;
import office.fc.hssf.formula.function.FinanceFunction;
import office.fc.hssf.formula.function.Function;
import office.fc.hssf.formula.function.FunctionMetadata;
import office.fc.hssf.formula.function.FunctionMetadataRegistry;
import office.fc.hssf.formula.function.Hlookup;
import office.fc.hssf.formula.function.Hyperlink;
import office.fc.hssf.formula.function.IfFunc;
import office.fc.hssf.formula.function.Index;
import office.fc.hssf.formula.function.Irr;
import office.fc.hssf.formula.function.LogicalFunction;
import office.fc.hssf.formula.function.Lookup;
import office.fc.hssf.formula.function.Match;
import office.fc.hssf.formula.function.MinaMaxa;
import office.fc.hssf.formula.function.Mode;
import office.fc.hssf.formula.function.Na;
import office.fc.hssf.formula.function.NotImplementedFunction;
import office.fc.hssf.formula.function.Now;
import office.fc.hssf.formula.function.Npv;
import office.fc.hssf.formula.function.NumericFunction;
import office.fc.hssf.formula.function.Odd;
import office.fc.hssf.formula.function.Offset;
import office.fc.hssf.formula.function.Replace;
import office.fc.hssf.formula.function.RowFunc;
import office.fc.hssf.formula.function.Rows;
import office.fc.hssf.formula.function.Substitute;
import office.fc.hssf.formula.function.Subtotal;
import office.fc.hssf.formula.function.Sumif;
import office.fc.hssf.formula.function.Sumproduct;
import office.fc.hssf.formula.function.Sumx2my2;
import office.fc.hssf.formula.function.Sumx2py2;
import office.fc.hssf.formula.function.Sumxmy2;
import office.fc.hssf.formula.function.T;
import office.fc.hssf.formula.function.TextFunction;
import office.fc.hssf.formula.function.TimeFunc;
import office.fc.hssf.formula.function.Today;
import office.fc.hssf.formula.function.Value;
import office.fc.hssf.formula.function.Vlookup;
import office.fc.hssf.formula.function.Weekday;
