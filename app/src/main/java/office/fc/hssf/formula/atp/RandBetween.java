...
==================================================================== */
package office.fc.hssf.formula.atp;


import office.fc.hssf.formula.OperationEvaluationContext;
...
final class RandBetween implements FreeRefFunction{
	 ...
	 * than top.
	 * 
	 * @see office.fc.hssf.formula.function.FreeRefFunction#evaluate(office.fc.hssf.formula.eval.ValueEval[], office.fc.hssf.formula.OperationEvaluationContext)
	 */
