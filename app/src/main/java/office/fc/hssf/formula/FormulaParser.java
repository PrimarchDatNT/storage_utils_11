...
import office.constant.fc.ErrorConstant;
import office.fc.hssf.formula.function.FunctionMetadata;
import office.fc.hssf.formula.function.FunctionMetadataRegistry;
import office.fc.hssf.formula.ptg.AbstractFunctionPtg;
import office.fc.hssf.formula.ptg.AddPtg;
import office.fc.hssf.formula.ptg.Area3DPtg;
import office.fc.hssf.formula.ptg.AreaPtg;
import office.fc.hssf.formula.ptg.ArrayPtg;
import office.fc.hssf.formula.ptg.AttrPtg;
import office.fc.hssf.formula.ptg.BoolPtg;
import office.fc.hssf.formula.ptg.ConcatPtg;
import office.fc.hssf.formula.ptg.DividePtg;
import office.fc.hssf.formula.ptg.EqualPtg;
import office.fc.hssf.formula.ptg.ErrPtg;
import office.fc.hssf.formula.ptg.FuncPtg;
import office.fc.hssf.formula.ptg.FuncVarPtg;
import office.fc.hssf.formula.ptg.GreaterEqualPtg;
import office.fc.hssf.formula.ptg.GreaterThanPtg;
import office.fc.hssf.formula.ptg.IntPtg;
import office.fc.hssf.formula.ptg.LessEqualPtg;
import office.fc.hssf.formula.ptg.LessThanPtg;
...
import office.fc.hssf.formula.ptg.MultiplyPtg;
import office.fc.hssf.formula.ptg.NamePtg;
import office.fc.hssf.formula.ptg.NameXPtg;
import office.fc.hssf.formula.ptg.NotEqualPtg;
...
import office.fc.hssf.formula.ptg.ParenthesisPtg;
import office.fc.hssf.formula.ptg.PercentPtg;
import office.fc.hssf.formula.ptg.PowerPtg;
import office.fc.hssf.formula.ptg.Ptg;
import office.fc.hssf.formula.ptg.RangePtg;
...
import office.fc.hssf.formula.ptg.SubtractPtg;
import office.fc.hssf.formula.ptg.UnaryMinusPtg;
import office.fc.hssf.formula.ptg.UnaryPlusPtg;
import office.fc.hssf.formula.ptg.UnionPtg;
import office.fc.hssf.formula.ptg.ValueOperatorPtg;
import office.fc.ss.SpreadsheetVersion;
import office.fc.ss.usermodel.ErrorConstants;
import office.fc.ss.util.AreaReference;
import office.fc.ss.util.CellReference;
import office.fc.ss.util.CellReference.NameType;
...
public final class FormulaParser {
	 ...
	 * (copied+modified from {@link office.fc.ss.util.CellReference#CELL_REF_PATTERN})
	 */
