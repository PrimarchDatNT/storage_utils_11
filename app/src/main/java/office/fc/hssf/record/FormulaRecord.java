...
public final class FormulaRecord extends CellRecord {
	...
	private static final class SpecialCachedValue {
		...
		public int getValueType()
		{
			...
			switch (typeCode)
			{
				case STRING:	 return Cell.CELL_TYPE_STRING;
				case BOOLEAN:	return Cell.CELL_TYPE_BOOLEAN;
				case ERROR_CODE: return Cell.CELL_TYPE_ERROR;
				case EMPTY:	  return Cell.CELL_TYPE_STRING; // is this correct?
			}
