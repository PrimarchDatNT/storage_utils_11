...
import office.common.bookmark.Bookmark;
import office.common.borders.Border;
import office.common.borders.Borders;
import office.common.borders.Line;
import office.common.bulletnumber.ListData;
import office.common.bulletnumber.ListLevel;
import office.common.hyperlink.Hyperlink;
import office.common.picture.Picture;
...
import office.common.shape.WPAbstractShape;
import office.common.shape.WPAutoShape;
import office.common.shape.WPGroupShape;
import office.common.shape.WPPictureShape;
...
import office.fc.ddf.EscherContainerRecord;
import office.fc.ddf.EscherOptRecord;
import office.fc.ddf.EscherProperties;
import office.fc.ddf.EscherSimpleProperty;
import office.fc.ddf.EscherTextboxRecord;
import office.fc.hwpf.HWPFDocument;
import office.fc.hwpf.model.FieldsDocumentPart;
import office.fc.hwpf.model.ListFormatOverride;
import office.fc.hwpf.model.ListTables;
import office.fc.hwpf.model.POIListData;
import office.fc.hwpf.model.POIListLevel;
import office.fc.hwpf.model.PicturesTable;
import office.fc.hwpf.usermodel.Bookmarks;
import office.fc.hwpf.usermodel.BorderCode;
import office.fc.hwpf.usermodel.CharacterRun;
import office.fc.hwpf.usermodel.Field;
import office.fc.hwpf.usermodel.HWPFAutoShape;
import office.fc.hwpf.usermodel.HWPFShape;
import office.fc.hwpf.usermodel.HWPFShapeGroup;
import office.fc.hwpf.usermodel.HeaderStories;
import office.fc.hwpf.usermodel.InlineWordArt;
import office.fc.hwpf.usermodel.LineSpacingDescriptor;
import office.fc.hwpf.usermodel.OfficeDrawing;
import office.fc.hwpf.usermodel.OfficeDrawings;
import office.fc.hwpf.usermodel.POIBookmark;
import office.fc.hwpf.usermodel.Paragraph;
import office.fc.hwpf.usermodel.PictureType;
import office.fc.hwpf.usermodel.Range;
import office.fc.hwpf.usermodel.Section;
import office.fc.hwpf.usermodel.Table;
import office.fc.hwpf.usermodel.TableCell;
import office.fc.hwpf.usermodel.TableRow;
import office.fc.util.LittleEndian;
import office.java.awt.Rectangle;
import office.java.util.Arrays;
...
import office.ss.util.ModelUtil;
import office.system.AbstractReader;
import office.system.IControl;
import office.wp.model.CellElement;
import office.wp.model.HFElement;
import office.wp.model.RowElement;
import office.wp.model.TableElement;
    ...
    private BackgroundAndFill converFill(HWPFAutoShape shape, OfficeDrawing drawing, int shapeType)
    {
        ...
        if (shape != null)
        {
            		...
            		|| type == BackgroundAndFill.FILL_SHADE_RECT || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	office.java.awt.Color fillColor = shape.getForegroundColor();
            	office.java.awt.Color fillbackColor = shape.getFillbackColor();
   ...
   /*         	byte[] data = drawing.getBGPictureData(shape.getBackgroundPictureIdx());
    ...
    private void processWordArtTextbox(EscherContainerRecord escherContainer, WPAutoShape autoShape)
    {
		...
		if(text != null && text.length() > 0)
		{
            ...
            // 字符颜色
            office.java.awt.Color color = ShapeKit.getForegroundColor(escherContainer, null, MainConstant.APPLICATION_TYPE_PPT);
            if(color != null)
            {
    ...
    private boolean processShape(CharacterRun run, IElement leaf, boolean isWrap, int runIndex)
    {
        ...
        else
        {
            ...
            office.fc.hwpf.usermodel.Picture pic = pictureTable.extractPicture(control.getSysKit().getPictureManage().getPicTempPath(),
                run, false);
