        ...
        extends EscherRecord
{
    ...
    public int fillFields(byte[] data, int offset, EscherRecordFactory recordFactory) {
        ...
        else
        {
        	...
        	{
        		field_1_flag   =  LittleEndian.getShort( data, pos + size );     size += 4;
                field_2_col1   =  LittleEndian.getShort( data, pos + size );     size += 4;
                field_3_dx1    =  LittleEndian.getShort( data, pos + size );     size += 4;
                field_4_row1   =  LittleEndian.getShort( data, pos + size );     size += 4;
                shortRecord = false;
        	}
        	else
        	{
