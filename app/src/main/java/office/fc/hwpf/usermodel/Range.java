...
import office.fc.hwpf.HWPFDocumentCore;
import office.fc.hwpf.model.CHPX;
import office.fc.hwpf.model.FileInformationBlock;
import office.fc.hwpf.model.ListTables;
import office.fc.hwpf.model.PAPX;
import office.fc.hwpf.model.PropertyNode;
import office.fc.hwpf.model.SEPX;
...
import office.fc.hwpf.sprm.CharacterSprmCompressor;
import office.fc.hwpf.sprm.ParagraphSprmCompressor;
import office.fc.hwpf.sprm.SprmBuffer;
...
{ // TODO -instantiable superclass
    ...
    public Table getTable(Paragraph paragraph)
    {
        ...
        {
            logger.log(POILogger.WARN, "The table's bounds ", "[" + this._parStart + "; "
                + tableEndInclusive + ")", " fall outside of this Range paragraphs numbers ", "["
