...
import office.fc.hpsf.DocumentSummaryInformation;
import office.fc.hpsf.MutablePropertySet;
import office.fc.hpsf.PropertySet;
import office.fc.hpsf.PropertySetFactory;
import office.fc.hpsf.SummaryInformation;
import office.fc.poifs.filesystem.DirectoryEntry;
import office.fc.poifs.filesystem.DirectoryNode;
import office.fc.poifs.filesystem.DocumentInputStream;
import office.fc.poifs.filesystem.Entry;
import office.fc.poifs.filesystem.NPOIFSFileSystem;
...
import office.fc.util.POIUtils;
...
public abstract class POIDocument
{
    ...
    protected PropertySet getPropertySet(String setName)
    {
        ...
        catch(office.fc.hpsf.HPSFException he)
        {
            // Oh well, doesn't exist
            logger.log(POILogger.WARN, "Error creating property set with name " + setName + "\n"
                + he);
        ...
        throws IOException
    {
        ...
        catch(office.fc.hpsf.WritingNotSupportedException wnse)
        {
