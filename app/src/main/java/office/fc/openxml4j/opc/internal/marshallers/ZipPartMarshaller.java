...
package office.fc.openxml4j.opc.internal.marshallers;
...
import office.fc.openxml4j.opc.PackagePartName;
...
public final class ZipPartMarshaller implements PartMarshaller
{
    ...
    {/*
        ...
        ZipEntry partEntry = new ZipEntry(ZipHelper.getZipItemNameFromOPCName(part.getPartName()
            .getURI().getPath()));
        try
        {
        ...
        {
            PackagePartName relationshipPartName = PackagingURIHelper.getRelationshipPartName(part
                .getPartName());
        ...
        PackagePartName relPartName, ZipOutputStream zos)
    {
        ...
        Element root = xmlOutDoc.addElement(new QName(PackageRelationship.RELATIONSHIPS_TAG_NAME,
            dfNs));
        ...
        URI sourcePartURI = PackagingURIHelper.getSourcePartUriFromRelationshipPartUri(relPartName
            .getURI());
        ...
        for (PackageRelationship rel : rels)
        {
            ...
            relElem
                .addAttribute(PackageRelationship.TYPE_ATTRIBUTE_NAME, rel.getRelationshipType());
            ...
            else
            {
                ...
                targetValue = PackagingURIHelper.relativizeURI(sourcePartURI, targetURI, true)
                    .toString();
            }
