...
public interface IRow extends Iterable<ICell> {
     ...
     * <p>
     * The cell that is returned is a {@link ICell#CELL_TYPE_BLANK}. The type can be changed
     ...
     * @see #getCell(int, com.office.fc.ss.usermodel.IRow.MissingCellPolicy)
     */
    ICell getCell(int cellnum);

    /**
     * Returns the cell at the given (0 based) index, with the specified {@link com.office.fc.ss.usermodel.IRow.MissingCellPolicy}
     *
     * @return the cell at the given (0 based) index
     * @throws IllegalArgumentException if cellnum < 0 or the specified MissingCellPolicy is invalid
     * @see IRow#RETURN_NULL_AND_BLANK
     * @see IRow#RETURN_BLANK_AS_NULL
     * @see IRow#CREATE_NULL_AS_BLANK
     */
