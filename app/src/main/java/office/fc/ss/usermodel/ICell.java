...
package office.fc.ss.usermodel;
...
public interface ICell {
     ...
     *
     * @return the cell type
     * @see ICell#CELL_TYPE_BLANK
     * @see ICell#CELL_TYPE_NUMERIC
     * @see ICell#CELL_TYPE_STRING
     * @see ICell#CELL_TYPE_FORMULA
     * @see ICell#CELL_TYPE_BOOLEAN
     * @see ICell#CELL_TYPE_ERROR
     */
    int getCellType();
     ...
     * data type is now something besides {@link ICell#CELL_TYPE_NUMERIC}.  POI
     * does not attempt to replicate this behaviour.  To make a numeric cell
     * display as a date, use {@link #setCellStyle(ICellStyle)} etc.
     *
     * @param value the numeric value to set this cell to.  For formulas we'll set the
     *        precalculated value, for numerics we'll set its value. For other types we
     ...
     * @see office.ss.model.baseModel.office.fc.ss.usermodel.Workbook#createCellStyle()
     */
