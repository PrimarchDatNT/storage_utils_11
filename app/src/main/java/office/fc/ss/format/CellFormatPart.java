...
package office.fc.ss.format;

import static office.fc.ss.format.CellFormatter.logger;
import static office.fc.ss.format.CellFormatter.quote;
    ...
    static
    {
        ...
        for (HSSFColor color : colors.values())
        {
            ...
            if (name.equals(name.toUpperCase()))
            {
                ...
                int c = Color.rgb(rgb[0], rgb[1], rgb[2]);//new Color(rgb[0], rgb[1], rgb[2]);
